...
class Start extends Component {
  ...
  sliderClick = (e) => {
    ...
    this.setVideoByTime(offsetX / offsetWidth)
  }
  ...
  setVideoByTime = (percent) => {
    this.audio.currentTime = Math.floor(percent * (this.audio.duration || 0))
  }
  ...
  render () {
    ...
    const { running, percent, currentTime } = this.state
    ...
    return <div className="audio-controller">
      ...
      <div className="slider-wrapper">
        <p>{playing.name}</p>
        <div className="slider-runway" onClick={this.sliderClick}>
